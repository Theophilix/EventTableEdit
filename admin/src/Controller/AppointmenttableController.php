 ...
 * @since  1.6
 */
class AppointmenttableController extends FormController
{
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Appointmenttable', 'Administrator', array());

		// Preset the redirect
		$this->setRedirect(Route::_('index.php?option=com_eventtableedit&view=appointmenttable' . $this->getRedirectToListAppend(), false));
