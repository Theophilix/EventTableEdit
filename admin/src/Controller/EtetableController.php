...
class EtetableController extends FormController
{
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Etetable', 'Administrator', array());

		// Preset the redirect
		$this->setRedirect(Route::_('index.php?option=com_eventtableedit&view=etetables' . $this->getRedirectToListAppend(), false));
