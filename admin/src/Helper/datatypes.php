...
class Datatypes
{
    ...
    {
        $ret = [];
        $ret[] = Text::_('COM_EVENTTABLEEDIT_DATATYPE_TEXT');
        $ret[] = Text::_('COM_EVENTTABLEEDIT_DATATYPE_DATE');
        $ret[] = Text::_('COM_EVENTTABLEEDIT_DATATYPE_TIME');
        $ret[] = Text::_('COM_EVENTTABLEEDIT_DATATYPE_INT');
        $ret[] = Text::_('COM_EVENTTABLEEDIT_DATATYPE_FLOAT');
        $ret[] = Text::_('COM_EVENTTABLEEDIT_DATATYPE_BOOLEAN');
        $ret[] = Text::_('COM_EVENTTABLEEDIT_DATATYPE_LINK');
        $ret[] = Text::_('COM_EVENTTABLEEDIT_DATATYPE_MAIL');
        $ret[] = Text::_('COM_EVENTTABLEEDIT_DATATYPE_FOUR_STATE');
