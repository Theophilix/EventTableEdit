 ...
 * @since  1.0
 */
class AppointmenttableTable extends Table implements VersionableTableInterface
{
	...
	{
		$this->typeAlias = 'com_eventtableedit.appointmenttable';
	...
	public function store($updateNulls = true)
	{
		...
		$table = Table::getInstance('AppointmenttableTable', __NAMESPACE__ . '\\', array('dbo' => $this->getDbo()));
