 ...
 * @since  1.0
 */
class HeadsTable extends Table implements VersionableTableInterface
{
	...
	{
		$this->typeAlias = 'com_eventtableedit.heads';
	...
	public function store($updateNulls = true)
	{
		...
		$table = Table::getInstance('HeadsTable', __NAMESPACE__ . '\\', array('dbo' => $this->getDbo()));
