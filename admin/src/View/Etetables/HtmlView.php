...
namespace ETE\Component\EventTableEdit\Administrator\View\Etetables;
...
class HtmlView extends BaseHtmlView {
	...
	protected function addToolbar()
	{
		...
		if (!$this->isEmptyState && $canDo->get('core.edit'))
		{
			...
			$childBar->publish('etetables.publish')->listCheck(true);

			$childBar->unpublish('etetables.unpublish')->listCheck(true);

			$childBar->archive('etetables.archive')->listCheck(true);

			if ($user->authorise('core.admin'))
			{
				$childBar->checkin('etetables.checkin')->listCheck(true);
			}

			if ($this->state->get('filter.published') != -2)
			{
				$childBar->trash('etetables.trash')->listCheck(true);
			}
		...
		{
			$toolbar->delete('etetables.delete')
