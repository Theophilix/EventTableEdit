...
<legend><?php echo Text::_('COM_EVENTTABLEEDIT_APPEND_TABLE'); ?></legend>
...
<?php if (!$app->getUserState('com_eventtableedit.csvError', true)) :?>
	...
	<p><?php echo Text::_('COM_EVENTTABLEEDIT_IMPORT_REPORT_APPEND'); ?></p>
<?php else: ?>
	<div id="summaryHeadFailed"><?php echo Text::_('COM_EVENTTABLEEDIT_IMPORT_REPORT_FAILED'); ?></div>
	<p><?php echo Text::_('COM_EVENTTABLEEDIT_IMPORT_REPORT_APPEND_FAILED'); ?></p>
<?php endif; ?>